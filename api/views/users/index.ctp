<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('login_failed');?></th>
			<th><?php echo $this->Paginator->sort('ip_failed');?></th>
			<th><?php echo $this->Paginator->sort('login_success');?></th>
			<th><?php echo $this->Paginator->sort('ip_success');?></th>
			<th><?php echo $this->Paginator->sort('password_changed');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $user['User']['login_failed']; ?>&nbsp;</td>
		<td><?php echo $user['User']['ip_failed']; ?>&nbsp;</td>
		<td><?php echo $user['User']['login_success']; ?>&nbsp;</td>
		<td><?php echo $user['User']['ip_success']; ?>&nbsp;</td>
		<td><?php echo $user['User']['password_changed']; ?>&nbsp;</td>
